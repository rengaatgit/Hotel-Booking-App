...
public interface BookingConstants {
	...
	String E0006 = "E0006 - Only Alphabets and space are allowed for Guest name";
	String E0005 = "E0005 - The length of guest name cannot be more than 50 characters";
	String I0001 = " rooms/day are available for bookings";
	String I0002 = "No booking info is found for the guest ";
}
